 ...
 */
function generateLiveStreamCreateMsgBuf(component, endpoint, rtspurl, videoCodec, audioCodec, videoMode = 'sendonly', audioMode = 'sendonly') {
    ...
    endpointBuf = commonBuf.endpointBuf(builder, endpoint, rtspurl, true, videoChannelBuf, audioChannelBuf);
...
function generateLiveStreamAddViewerMsgBuf(component, endpoint, videoCodec, videoMode, audioCodec, audioMode) {
    ...
    let audioChannel = commonBuf.channelBuf(builder, 'audio', audioCodec, audioMode),
        ...
        endpointBuf = commonBuf.endpointBuf(builder, endpoint, null, null, videoChannel, audioChannel);
